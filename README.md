...
1. Download SQL Server 2025 Developer Edition from microsoft.com
2. Run installer — choose default instance `MSSQLSERVER`
3. Download SSMS 22 from aka.ms/ssmsfullsetup
4. Install SSMS — core components only, no extra workloads needed
5. Open SSMS → connect to localhost → Windows Authentication
6. Run `PricingDB_Complete.sql` to build entire database from scratch
